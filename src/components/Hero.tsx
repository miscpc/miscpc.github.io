      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-xs font-medium mb-6">
            ...
            Available for Strategic Solutions
          </div>
          ...
          <p className="text-lg text-zinc-400 mb-8 max-w-lg leading-relaxed">
            20+ years of engineering solutions across the full technology stack. 
            From bare-metal infrastructure and AI integration to complex system architecture.
            I don't just fix problems; I eliminate them.
          </p>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4">
              <div className="text-center">
                ...
                <div className="text-[10px] uppercase text-zinc-500 font-bold tracking-widest">Years</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">36</div>
                <div className="text-[10px] uppercase text-zinc-500 font-bold tracking-widest">Skills</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">8</div>
                <div className="text-[10px] uppercase text-zinc-500 font-bold tracking-widest">Companies</div>
              </div>
            </div>
          </div>
        </motion.div>
